          ...
          <?php 
           ...
           <div class="col-md-4 text-center wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="col-md-8 text-center wow fadeInUp" data-wow-delay="0.3s" style="margin-top: 60px;">
              <form method="POST" action="index.php?route=pd/directcommission/payment_daily&token=<?php echo $_GET['token'] ?>" style="">
        ...
        ?>
          <tr>
           ...
           <td><?php echo $value['description'] ?></td>
            ...
            <td><?php echo ($value['amount_btc']/100000000) ?> BTC</td>
