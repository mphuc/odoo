...
<head>
  ...
  <main>
          ...
          <div class="alert alert-info">
           ...
           <form  class="oe_login_form" role="form"  onsubmit="this.action = this.action + location.hash" action="index.php?route=account/lock" method="post">
         ...
         <div class="form-group">
            ...
            <input type="text" name="authenticator" value="" placeholder="Your authenticator code" class="form-control" id="email">
         </div>
