...
<head>
    ...
    <!-- <script  type="text/javascript" src="catalog/view/theme/default/template_home/assets/js/web.assets_frontend.js"></script> -->
        ...
        <div id="wrapwrap" class="o_pricing">
            <header id="header" class="o_not_editable o_main_header o_has_sub_nav o_inverted ">
        ...
        <nav class="navbar o_sub_nav">
            <div class="container">
                <a class="navbar-header" href="#">
                    ...
                    <span class="o_app_name_title"><span>|</span>Pricing</span>
                </a>
  ...
  <main>
      ...
      <div id="wrap" class="oe_structure">
        <section class="s_banner o_gradient js_top_banner">
          <div class="container text-center mt16 mb48">
            <h1 class="mt16 mb48 display-2 text-white">Pricing</h1>
          </div>
        </section>
        <section class="o_offset_top_medium">
          <div class="container mb16">
            <div class="pricing-table o_overflow_hidden row">
              
        <div class="clearfix "></div>
        <div class="pricing-col description ">
            <div class="top">
                <div class="suitable small text-heading fw_medium">Daily Rates:</div>
            </div>
            <div class="pricing-row text-heading text-left">Referral Program</div>
            <div class="pricing-row text-heading text-left">Binary Bonuses</div>
            <div class="pricing-row text-heading text-left">Daily profit percentage, %</div>
            <div class="pricing-row text-heading text-left">Withdrawal</div>
            <div class="pricing-row text-heading text-left">Time for Payment</div>
            <div class="pricing-row text-heading text-left">Support</div>
        </div>
    
              <div class="pricing-col free-offer">
                <div class="pricing-card">
                  <div class="top">
                    <div class="mt4 mb4 o_overflow_hidden">
                      <h4 class="text-uppercase mb16 mt16">Starter</h4>
                    </div>
                    <div class="banner fw_regular">
                      <b style=" font-size: 25px;">0.05</b> BTC <br class="visible-md"/>
                      <small>for</small>
                      <b>70 days</b>
                    </div>
                    <div class="suitable fw_regular text-heading">
                     
                      <p>2.5% Daily</p>
                     
                    </div>
                    <div class="btn-container">
                      <a href="signup.php" class="btn btn-primary btn-block text-uppercase" id="pricing_start_button">Start now</a>
                    </div>
                  </div>
                  <div class="pricing-row"><b>5</b> % </div>
                  <div class="pricing-row"><b>10</b> % (<small>Condition: 2 F1</small>)</div>
                  <div class="pricing-row"><b>2.5</b> % (<small>Mon - Sat</small>)</div>
                  ...
                  <div class="pricing-row">
                    <span class="o_pic o_pic_check"></span>
                  </div>
                </div>
              </div>
              
        <div class="clearfix visible-xs-block"></div>
        <div class="pricing-col description visible-xs-block">
            <div class="top">
                <div class="suitable small text-heading fw_medium">Daily Rates:</div>
            </div>
            <div class="pricing-row text-heading text-left">Referral Program</div>
            ...
            <div class="pricing-row text-heading text-left">Support</div>
              ...
              <div class="pricing-col online">
                <div class="pricing-card">
                  <div class="top">
                    <div class="mt4 mb4 o_overflow_hidden">
                      <h4 class="text-uppercase mb16 mt16">Merchant</h4>
                    </div>
                    <div class="banner fw_regular">
                      <b style=" font-size: 25px;">0.1</b> BTC <br class="visible-md"/>
                      <small>for</small>
                      <b>70 days</b>
                    </div>
                    <div class="suitable fw_regular text-heading">
                    ...
                    <div class="btn-container">
                      <a href="signup.php" class="btn btn-default btn-block text-uppercase">Start now</a>
                    </div>
                  </div>
                  <div class="pricing-row"><b>5</b> % </div>
                  <div class="pricing-row"><b>10</b> % (<small>Condition: 2 F1</small>) </div>
                  <div class="pricing-row"><b>3</b> % (<small>Mon - Sat</small>)</div>
                  <div class="pricing-row">
                    Sunday
                  </div>
                  <div class="pricing-row">
        ...
        <section class="s_sponsors text-center">
          <div class="container mb48">
            <div class="text-uppercase fw_bold mb8" style="font-size: 9px">Used and trusted by</div>
            <div class="row">
              <div class="col-sm-9 col-md-8 col-md-offset-2 s_sponsors_list">
        ...
        <section class="bg-white">
          <div class="container">
            <div class="row o_v_align_col_sm">
              <div class="col-sm-6 col-lg-5 mb48 text-center-xs">
                <h2 class="display-3 mt32 mb16">Need <b>help?</b> </h2>
                <p class="font-heading text-heading mb24">Contact us to get a quote or a custom-tailored demonstration with one of our business advisors.</p>
              ...
              <div class="col-sm-6 col-lg-5 col-lg-offset-2 hidden-xs">
                <img src="catalog/view/theme/default/template_home/assets/images/support_banner.jpg" class="img-responsive pull-right" alt=""/>
              </div>
            </div>
          </div>
        </section>
